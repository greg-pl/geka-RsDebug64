...
procedure TMemFrame.GRidDrawCell(Sender: TObject; ACol,
...
procedure TMemFrame.GridKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  k : word;
  Grid : TStringGrid;
...
procedure TMemFrame.GridGetEditText(Sender: TObject; ACol,
...
procedure TMemFrame.ByteGridSetEditText(Sender: TObject; ACol,
...
procedure TMemFrame.ByteGridSelectCell(Sender: TObject; ACol,
...
procedure TMemFrame.WordGRidSetEditText(Sender: TObject; ACol,
  ARow: Integer; const Value: String);
var
  k  : TCellState;
  OK : boolean;
...
procedure TMemFrame.DWordGridSetEditText(Sender: TObject; ACol,
  ARow: Integer; const Value: String);
var
  k  : TCellState;
  OK : boolean;
...
procedure TMemFrame.FloatGridSetEditText(Sender: TObject; ACol,
  ARow: Integer; const Value: String);
var
  k  : TCellState;
  OK : boolean;
...
procedure TMemFrame.DFloatGridSetEditText(Sender: TObject; ACol,
  ARow: Integer; const Value: String);
var
  k  : TCellState;
  OK : boolean;
...
procedure TMemFrame.F1_15GridSetEditText(Sender: TObject; ACol,
  ARow: Integer; const Value: String);
var
  k  : TCellState;
  OK : boolean;
...
procedure TMemFrame.MeasurePanelEndDock(Sender, Target: TObject; X,
  Y: Integer);
begin
...
begin
  ...
  0 : begin Gr := ByteGrid;    N := 16; end;
  1 : begin Gr := WordGrid;    N := 16; end;
  2 : begin Gr := DWordGrid;   N := 8; end;
  3 : begin Gr := FloatGrid;   N := 8; end;
  4 : begin Gr := DFloatGrid;  N := 8; end;
  5 : begin Gr := DspProgGrid; N := 8; end;
  6 : begin Gr := F1_15Grid;   N := 16; end;
  end;
  if Assigned(Gr) then
  begin
